...
public class FlingViewGroup extends ViewGroup {
    public static final String TAG = FlingViewGroup.class.getName();
    ...
    public FlingViewGroup(Context context, AttributeSet attrs) {
        ...
        mScroller = new Scroller(context, new DecelerateInterpolator(6));
    ...
    public void setPosition(int position) {
        ...
        scrollTo(mCurrentView * getMeasuredWidth(), 0);
    }
    ...
    protected void onScrollChanged(int l, int t, int oldl, int oldt) {
        ...
        if (mViewSwitchListener != null) {
            float progress = (float) l
                    / (float) (getWidth() * (getChildCount() - 1));
